...
<Source dark of={ColorSchemesStories.Apply} language="tsx" />
...
<Source dark of={ColorSchemesStories.ApplySystem} language="tsx" />
...
<Source dark of={ColorSchemesStories.UseColorSchemeValueStory} language="tsx" />
