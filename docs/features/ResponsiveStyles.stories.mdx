...
<Preview>
    <Div backgroundColor={{ base: "green-2", xs: "purple-2", sm: "green-2", md: "sapphire-200", lg: "neutral-2", xl: "warning-2" }} width="30rem" maxWidth="100%" padding={160}>
...
<Preview>
    <Div backgroundColor={{ base: "alias-success", lg: "alias-warning" }} width="30rem" maxWidth="100%" padding={160}>
        <Paragraph fontSize={4}>Lost in space.</Paragraph>
    </Div>
</Preview>
