...
<Preview>
    <Div backgroundColorHover="status-positive-surface" backgroundColor="warning-surface-weak" padding={160} width="30rem" maxWidth="100%" borderRadius={2}>
        <Paragraph fontSize={4}>Lost in space.</Paragraph>
    </Div>
</Preview>
...
```jsx
<Text backgroundColor="primary-surface-weak" color="#FFFFFF">
    Galaxy
</Text>
```
