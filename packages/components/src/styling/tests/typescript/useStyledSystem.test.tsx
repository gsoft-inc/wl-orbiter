...
expectAssignable<BackgroundColorProp>("primary-surface");
...
expectAssignable<BorderProp>("danger-border");
...
expectAssignable<BorderBottomProp>("danger-border");
...
expectAssignable<BorderLeftProp>("danger-border");
...
expectAssignable<BorderRightProp>("danger-border");
...
expectAssignable<BorderTopProp>("danger-border");
...
expectAssignable<ColorProp>("primary-text");
...
expectAssignable<FillProp>("primary-icon");
...
expectAssignable<StrokeProp>("primary-icon");
