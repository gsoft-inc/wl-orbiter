...
const Props: PropDefinition[] = [
    ...
    { name: "background color/active", key: "backgroundColorActive", values: [...Object.keys(BackgroundColorMapping), ...ColorSampling, ...GlobalSampling] },
    ...
    { name: "border bottom/active", key: "borderBottomActive", values: [...Object.keys(BorderMapping), ...ColorSampling, ...GlobalSampling] },
    ...
    { name: "border left/active", key: "borderLeftActive", values: [...Object.keys(BorderMapping), ...ColorSampling, ...GlobalSampling] },
    ...
    { name: "border right/active", key: "borderRightActive", values: [...Object.keys(BorderMapping), ...ColorSampling, ...GlobalSampling] },
    ...
    { name: "border top/active", key: "borderTopActive", values: [...Object.keys(BorderMapping), ...ColorSampling, ...GlobalSampling] },
    ...
    { name: "box shadow/active", key: "boxShadowActive", values: [...Object.keys(BoxShadowMapping), "none", "10px 5px 5px black", ...GlobalSampling] },
    ...
    { name: "color/active", key: "colorActive", values: [...Object.keys(TextColorMapping), ...ColorSampling, ...GlobalSampling] },
    ...
    { name: "opacity/active", key: "opacityActive", values: ["0.9", "90%", ...GlobalSampling] },
    { name: "opacity/focus", key: "opacityFocus", values: ["0.9", "90%", ...GlobalSampling] },
