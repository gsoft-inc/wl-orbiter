...
import { InnerNumberInput, NumberInput } from "@components/number-input/index.js";
...
<Preview>
    <Story name="readonly">
        <NumberInput readOnly defaultValue={18} placeholder="Age" />
    </Story>
</Preview>
...
<Preview filePath="/number-input/docs/RequiredAgeValidation" />

### Controlled

A number input `value` can be handled in controlled mode.

<Preview filePath="/number-input/docs/ControlledNumberInput" />
...
<ArgsTable of={InnerNumberInput} sort="alpha" />
