...
const meta = {
    title: "Chromatic/IconButton-hopper/negative",
        ...
        <Inline gap="4.5rem">
            ...
            <Stack>
                ...
                <Inline alignY="end">
                    ...
                    <IconButton disabled focus size="xs" aria-label="Add" variant="negative">
                        <AddIcon />
                    </IconButton>
                    <IconButton disabled focus size="sm" aria-label="Add" variant="negative">
                        <AddIcon />
                    </IconButton>
                    <IconButton disabled focus aria-label="Add" variant="negative">
                        <AddIcon />
                    </IconButton>
                </Inline>
                <Inline alignY="end">
