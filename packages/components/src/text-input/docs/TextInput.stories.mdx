...
import { InnerPasswordInput, InnerSearchInput, InnerTextInput, PasswordInput, SearchInput, TextInput } from "@components/text-input";
...
<Preview>
    <Story name="icon">
        <TextInput icon={<PencilMajorIcon />} placeholder="Where to?" />
    </Story>
</Preview>
...
<Preview>
    <Story name="readonly">
        <TextInput readOnly defaultValue="Deep space" placeholder="Where to?" />
    </Story>
</Preview>
...
<Preview filePath="/text-input/docs/ControlledTextInput" />
...
<ArgsTable of={InnerTextInput} sort="alpha" />
...
<ArgsTable of={InnerSearchInput} sort="alpha" />
...
<ArgsTable of={InnerPasswordInput} sort="alpha" />
