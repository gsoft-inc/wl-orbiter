import { ArgTypes, Meta, Canvas, ArgTypesanvas } from "@storybook/addon-docs";
import { ComponentInfo, Tagline } from "@stories/components";
import { InnerContent, InnerFooter, InnerHeader } from "@components/placeholders/index.ts";
import { InnerModal, InnerModalTrigger } from "@components/modal/index.ts";
