...
import { H3, HeadingProps, Text } from "../../typography/index.js";
import { InteractionProps, InternalProps, OmitInternalProps, StyledComponentProps, cssModule, mergeProps, omitProps, useSlots } from "../../shared/index.js";
