...
const meta = {
    title: "Chromatic/Accordion-hopper/bordered",
    component: Accordion
...
export const ConditionalRendering: AccordionStory = {
    ...
    render: () => (
        <Stack>
            <Accordion variant="bordered" defaultExpandedKeys={["jupiter"]}>
                <Item key="mars">
                    <H3>Mars</H3>
                    <Content>Mars is the fourth planet from the Sun and the second-smallest planet in the Solar System.</Content>
                </Item>
            ...
            <Accordion variant="bordered" expansionMode="multiple" expandedKeys={["mars", "venus"]}>
                <Item key="mars">
                    <H3>Mars</H3>
                    <Content>Mars is the fourth planet from the Sun and the second-smallest planet in the Solar System.</Content>
                </Item>
...
export const ExpandedKeys: AccordionStory = {
    ...
    render: () => (
        <Stack>
            ...
            <Accordion variant="bordered" expansionMode="multiple" expandedKeys={["0", "2"]}>
                <Item>
                    <H3>Mars</H3>
                    <Content>Mars is the fourth planet from the Sun and the second-smallest planet in the Solar System.</Content>
                </Item>
