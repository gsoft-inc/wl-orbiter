...
import { GalaxyImage, GalaxyImage2x, GalaxyImageLg, NoResults } from "./assets/index.js";
import { Image, InnerImage, InnerSvgImage, SvgImage } from "@components/image/index.js";
...
<Preview scope={{ GalaxyImage }}>
    <Story name="shape">
        <Inline>
            <Image shape="rounded" src={GalaxyImage} alt="Galaxy" width={960} height={960} />
            <Image shape="circular" src={GalaxyImage} alt="Galaxy" width={960} height={960} />
        </Inline>
    </Story>
</Preview>
...
<Preview scope={{ NoResults }}>
    <Story name="svg image">
        <SvgImage src={NoResults} stroke="sapphire-600" aria-label="No results" />
    </Story>
</Preview>
...
<Preview scope={{ NoResults }}>
    <Story name="svg image size">
        <SvgImage width="150px" height="150px"stroke="sapphire-600" src={NoResults} aria-label="No results" />
    </Story>
</Preview>
...
<Preview scope={{ NoResults }}>
    <Story name="svg image color">
        <SvgImage stroke="sapphire-600" fill="sunken-treasure-100" src={NoResults} aria-label="No results" />
    </Story>
</Preview>
