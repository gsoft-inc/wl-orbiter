...
const meta = {
    title: "Chromatic/Tile/horizontal",
    component: Tile
} as Meta<typeof Tile>;
...
export const DefaultChecked: TileStory = {
    ...
    render: () => (
        <Tile orientation="horizontal" width="600px" defaultChecked>
            <Heading>Fuel</Heading>
            <Content>Fuel configuration and level</Content>
        </Tile>
    )
...
export const States: TileStory = {
    ...
    render: () => (
        <Stack>
            <Inline>
                <Tile orientation="horizontal" width="600px" active>
                    <Heading>Fuel</Heading>
                    <Content>Fuel configuration and level</Content>
                </Tile>
                <Tile orientation="horizontal" width="600px" focus>
                    <Heading>Fuel</Heading>
                    <Content>Fuel configuration and level</Content>
                </Tile>
                <Tile orientation="horizontal" width="600px" hover>
                    <Heading>Fuel</Heading>
                    <Content>Fuel configuration and level</Content>
                </Tile>
                <Tile orientation="horizontal" width="600px" focus hover>
                    <Heading>Fuel</Heading>
                    <Content>Fuel configuration and level</Content>
                </Tile>
            </Inline>
            <Inline>
                <Tile orientation="horizontal" width="600px" disabled>
                    <Heading>Fuel</Heading>
                    <Content>Fuel configuration and level</Content>
                </Tile>
                <Tile orientation="horizontal" width="600px" disabled active>
                    <Heading>Fuel</Heading>
                    <Content>Fuel configuration and level</Content>
                </Tile>
                <Tile orientation="horizontal" width="600px" disabled hover>
                    <Heading>Fuel</Heading>
                    <Content>Fuel configuration and level</Content>
                </Tile>
                <Tile orientation="horizontal" width="600px" disabled focus>
                    <Heading>Fuel</Heading>
                    <Content>Fuel configuration and level</Content>
                </Tile>
            </Inline>
...
export const Styling: TileStory = {
    ...
    render: () => (
        <Stack>
            <Tile orientation="horizontal" width="600px" border="sunken-treasure-900">
                <Heading>Map</Heading>
                <Content>View space map</Content>
            </Tile>
            <Tile orientation="horizontal" width="600px" className="border-red">
                <Heading>Map</Heading>
                <Content>View space map</Content>
            </Tile>
            <Tile orientation="horizontal" width="600px" style={{ border: "1px solid red" }}>
                <Heading>Map</Heading>
                <Content>View space map</Content>
            </Tile>
        </Stack>
