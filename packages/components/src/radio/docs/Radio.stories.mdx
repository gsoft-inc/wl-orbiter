...
import { InnerRadio, InnerRadioGroup, Radio, RadioGroup } from "@components/radio/index.js";
...
<ArgsTable of={InnerRadioGroup} sort="alpha" />
...
<ArgsTable of={InnerRadio} sort="alpha" />
