...
<Preview>
    <Story name="areas">
        <Grid
            ...
            height={10}
        >
            <Div gridArea="a" backgroundColor="accent-5" />
            <Div gridArea="b" backgroundColor="alert-5" />
            <Div gridArea="c" backgroundColor="green-5" />
        </Grid>
    </Story>
</Preview>
...
<Preview>
    <Story name="auto columns">
        <Grid
            ...
            height={10}
        >
            <Div gridColumn={2} backgroundColor="accent-5" />
            <Div backgroundColor="alert-5" />
            <Div backgroundColor="green-5" />
        </Grid>
    </Story>
...
<Preview>
    <Story name="column span">
        ...
        >
            ...
            <Div backgroundColor="alert-5" />
            <Div backgroundColor="green-5" />
            <Div gridColumnSpan={3} gridRow={2} backgroundColor="neutral-5" />
        </Grid>
    </Story>
</Preview>
