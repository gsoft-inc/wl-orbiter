...
import { PlaceholderMajorIcon, UfoMajorIcon, TelescopeMajorIcon, RocketMajorIcon } from "@components/icons";
...
<Preview>
    <Story name="validation">
        <Inline alignY="end">
            ...
            <Tag variant="outline" validationState="invalid" onRemove={() => {}}>Falcon 9</Tag>
        </Inline>
    </Story>
</Preview>
