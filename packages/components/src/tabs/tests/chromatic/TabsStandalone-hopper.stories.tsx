...
const meta = {
    title: "Chromatic/Tabs-hopper/standalone",
    component: Tabs,
    parameters: {
        chromatic: {
            delay: 100
...
export const Default: TabsStory = {
    name: "default",
    render: () => (
        <Tabs variant="standalone" aria-label="Planets">
            <Item>
                <Header>Mars</Header>
                <Content>
...
export const Fluid: TabsStory = {
    name: "fluid",
    render: () => (
        <Tabs variant="standalone" fluid aria-label="Planets">
            <Item>
                <Header>Mars</Header>
                <Content>
                    Mars is the fourth planet from the Sun and the second-smallest planet in the Solar System (in adherence with the IAU's controversial 2006 definition of planet),
...
export const SelectedKeyWithManualKeys: TabsStory = {
    ...
    render: () => (
        <Stack>
            <Tabs variant="standalone" defaultSelectedKey="jupiter" aria-label="Planets">
                <Item key="mars">
                    <Header>Mars</Header>
            ...
            <Tabs variant="standalone" selectedKey="jupiter" aria-label="Planets">
                <Item key="mars">
                    <Header>Mars</Header>
                    <Content>Mars is the fourth planet from the Sun and the second-smallest planet.</Content>
                </Item>
...
export const SelectedKeyWithGeneratedKeys: TabsStory = {
    ...
    render: () => (
        <Stack>
            <Tabs variant="standalone" defaultSelectedKey="1" aria-label="Planets">
                <Item>
                    <Header>Mars</Header>
                    <Content>Mars is the fourth planet from the Sun and the second-smallest planet.</Content>
                </Item>
            ...
            <Tabs variant="standalone" selectedKey="1" aria-label="Planets">
                <Item>
                    <Header>Mars</Header>
                    <Content>Mars is the fourth planet from the Sun and the second-smallest planet.</Content>
                </Item>
    ...
    render: () => (
        <Tabs variant="standalone" aria-label="Planets">
            <Item>
                <Header>
                    <Text>Mars</Text>
                    <TagGroup slot="lozenge" aria-label="New"><Tag>New</Tag></TagGroup>
                </Header>
                <Content>Mars is the fourth planet from the Sun and the second-smallest planet.</Content>
            </Item>
            <Item>
...
export const DisabledSelectedTabNotDefaultTab: TabsStory = {
    ...
    render: () => (
        <Tabs variant="standalone" selectedKey="0" aria-label="Planets">
            <Item disabled>
                <Header>
                    <NotificationIcon />
                    <Text>Mars</Text>
        ...
        <Div width="300px">
            <Tabs variant="standalone" aria-label="Planets">
                ...
                <Item key="earth">
                    <Header>
                        <Text>Earth</Text>
                        <TagGroup slot="lozenge" aria-label="Home"><Tag>Home</Tag></TagGroup>
                    </Header>
...
export const OverflowFluid: TabsStory = {
    ...
    render: () => (
        <Div width="300px">
            <Tabs variant="standalone" aria-label="Planets" fluid>
                <Item key="mars">
                    <Header>Mars</Header>
                    <Content>Mars is a dusty, cold, desert world with a very thin atmosphere. There is strong evidence Mars was—billions of years ago—wetter and warmer, with a thicker atmosphere.</Content>
                </Item>
...
export const OverflowNotCollapsible: TabsStory = {
    ...
    render: () => (
        <Div width="300px">
            <Tabs variant="standalone" aria-label="Planets" collapsible={false}>
                <Item key="mars">
                    <Header>Mars</Header>
                    <Content>Mars is a dusty, cold, desert world with a very thin atmosphere. There is strong evidence Mars was—billions of years ago—wetter and warmer, with a thicker atmosphere.</Content>
                </Item>
