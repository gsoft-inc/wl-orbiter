import { DismissIcon, SparklesIcon } from "@hopper-ui/icons";
import { Content, Header } from "@components/placeholders/index.js";
import { Inline, Stack } from "@components/layout/index.js";
import { Tab, TabPanel, Tabs, useTabsContext } from "@components/tabs/index.js";

import { Div } from "@components/html/index.js";
import { Item } from "@components/collection/index.js";
import { Text } from "@components/typography/index.js";
import { createTabsTestSuite } from "./createTabsTestSuite.js";
            ...
            <Div className="zoom-in">
                <Tabs aria-label="Planets">
                    <Item>
                        ...
                        <Content>
              Mars is the fourth planet from the Sun and the second-smallest
              planet in the Solar System (in adherence with the IAU's
              controversial 2006 definition of planet), being larger than only
              Mercury. In English, Mars carries the name of the Roman god of war
              and is often referred to as the "Red Planet".[17][18] The latter
              refers to the effect of the iron oxide prevalent on Mars's
              surface, which gives it a reddish appearance distinctive among the
              astronomical bodies visible to the naked eye. [19] Mars is a
              terrestrial planet with a thin atmosphere, with surface features
              reminiscent of the impact craters of the Moon and the valleys,
