...
import { PlaceholderMajorIcon, IconList, MagnifierMajorIcon, UfoMajorIcon, TelescopeMajorIcon, RocketMajorIcon } from "@components/icons";
...
<Preview>
    <Story name="trigger icon">
        <Select icon={<MagnifierMajorIcon />} placeholder="Planets">
            <Item key="earth">Earth</Item>
            <Item key="jupiter">Jupiter</Item>
            <Item key="mars">Mars</Item>
            <Item key="mercury">Mercury</Item>
