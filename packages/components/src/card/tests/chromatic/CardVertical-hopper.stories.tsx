...
export const Default: CardStory = {
    ...
    render: () => (
        <Stack>
            ...
            <Inline>
                <Card size="lg" orientation="vertical">
                    <Heading>Nasa</Heading>
                    <Content>The National Aeronautics and Space Administration</Content>
                </Card>
                <Card size="xl" orientation="vertical">
                    <Heading>Nasa</Heading>
                    <Content>The National Aeronautics and Space Administration</Content>
                </Card>
            </Inline>
...
export const Variant: CardStory = {
    ...
    render: () => (
        <Stack>
            <Inline>
                <Card variant="elevated" size="xs" orientation="vertical">
                    <Heading>Nasa</Heading>
                    <Content>The National Aeronautics and Space Administration</Content>
                </Card>
                <Card variant="elevated" size="sm" orientation="vertical">
                    <Heading>Nasa</Heading>
                    <Content>The National Aeronautics and Space Administration</Content>
                </Card>
                <Card variant="elevated" orientation="vertical">
                    <Heading>Nasa</Heading>
                    <Content>The National Aeronautics and Space Administration</Content>
                </Card>
            </Inline>
            <Inline>
                <Card variant="elevated" size="lg" orientation="vertical">
                    <Heading>Nasa</Heading>
                    <Content>The National Aeronautics and Space Administration</Content>
                </Card>
                <Card variant="elevated" size="xl" orientation="vertical">
                    <Heading>Nasa</Heading>
                    <Content>The National Aeronautics and Space Administration</Content>
                </Card>
            </Inline>
            <Card variant="elevated" fluid orientation="vertical">
                <Heading>Nasa</Heading>
                <Content>The National Aeronautics and Space Administration</Content>
            </Card>
        </Stack>
...
export const Illustration2: CardStory = {
    ...
    render: () => (
        <Stack>
            ...
            <Card height="250px" orientation="vertical">
                <Illustration color="sunken-treasure-100">
                    <Image src={Nasa} alt="Nasa" />
                </Illustration>
                <Heading>Nasa</Heading>
        ...
        <Stack>
            <Inline>
                <Card size="xs" orientation="vertical">
                    <Heading>Nasa</Heading>
                    <Header>
                        <Link href="https://www.nasa.gov">Website</Link>
                    </Header>
                    <Content>The National Aeronautics and Space Administration</Content>
                </Card>
                <Card size="sm" orientation="vertical">
