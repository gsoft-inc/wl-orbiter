...
<IconGallery>
    ...
    {renderItem("ArrowsUpDown", <ArrowsUpDownMajorIcon />)}
    ...
    {renderItem("FolderCross", <FolderCrossMajorIcon />)}
    ...
    {renderItem("NotificationRinging", <NotificationRingingMajorIcon />)}
...
<IconGallery>
    ...
    {renderItem("ArrowsUpDown", <ArrowsUpDownMinorIcon />)}
    ...
    {renderItem("StarFill", <StarFillMinorIcon />)}
    {renderItem("StarOutline", <StarOutlineMinorIcon />)}
...
function render() {
    return <Img src={CalendarMajorIcon24} alt="Calendar" width={400} height={400} />;
}
```
...
function render() {
    return <CalendarMajorIcon aria-label="Calendar" fill="sapphire-800" />
}
```
...
function render() {
    return <Img src={CalendarMajorIcon} alt="calendar" fill="sapphire-800" />;
}
```
